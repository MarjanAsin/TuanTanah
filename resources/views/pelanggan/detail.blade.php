       ...
       <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent pointer-events-none"></div>
        ...
        <button onclick="prevSlide()"
           class="absolute left-3 top-1/2 -translate-y-1/2
                ...
                rounded-full shadow-lg z-20 cursor-pointer font-inria">
            ‹
        </button>
        ...
        <div class="absolute bottom-0 left-0 p-6 text-white">
            ...
            <p class="flex items-center gap-2 text-sm opacity-90 mt-1 font-inria">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Tipe Properti</p>
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Luas Tanah</p>
                        <p class="font-semibold text-gray-600 font-inria">
                            {{ $properti->luas_tanah ?? '-' }}
                        </p>
                    </div>
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Luas Bangunan</p>
                        <p class="font-semibold text-gray-600 font-inria">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Kamar Tidur</p>
                        <p class="font-semibold text-gray-600 font-inria">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Kamar Mandi</p>
                        <p class="font-semibold text-gray-600 font-inria">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50">
                        <p class="text-gray-400 text-xs font-inria">Daya Listrik</p>
                        <p class="font-semibold text-gray-600 font-inria">
                            {{ $properti->daya_listrik ?? '-' }} VA
                        </p>
                    </div>
           ...
           <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <h3 class="font-semibold text-gray-800 mb-3 font-inria">
                    Deskripsi
                </h3>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl p-4 shadow-xl border border-gray-200 sticky top-6">
                ...
                @php
                    $wa = preg_replace('/[^0-9]/', '', $properti->user->nomor_whatsapp);
                ...
                <a href="https://api.whatsapp.com/send?phone={{ $wa }}&text={{ $pesan }}"
                target="_blank"
            ...
            {{-- PROPERTI LAINNYA --}}
            @if($propertiLainnya->count())
            <div class="bg-white rounded-xl p-4 shadow-xl border border-gray-200">
                ...
                <div class="space-y-3 max-h-[500px] overflow-y-auto pr-2">
                    ...
                    @foreach($propertiLainnya as $item)
                        ...
                        class="block border border-gray-100 rounded-xl overflow-hidden
                            ...
                            <div class="absolute top-3 right-3
                                        ...
                                        shadow font-bold font-inria z-10">
                            ...
                            <div class="p-3">
                                ...
                                <h4 class="font-semibold text-sm text-gray-800 line-clamp-2 font-inria">
                                    {{ $item->nama_properti }}
                                </h4>
